...
exports.setSchema = function (schema) {
  ...
  function query(type, query) {
    var queryParams = {
      selector: this._buildSelector(type, query.filter)
    };
    ...
    return db.find(queryParams).then(function(pouchRes) { return db.rel.parseRelDocs(recordTypeName, pouchRes.docs);});
  }
   ...
   */
  _buildSelector: function(type, selector) {
    var dataSelector = {
            '_id': {
